...
- (id)initWithSessionPreset:(AVCaptureSessionPreset)sessionPreset cameraPosition:(AVCaptureDevicePosition)cameraPosition;
{
	if (!(self = [super init]))
    {
		return nil;
	...
	{
		if ([device position] == cameraPosition && [device supportsAVCaptureSessionPreset:sessionPreset])
		{
			_inputCamera = device;
		}
	}
